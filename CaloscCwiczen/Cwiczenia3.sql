...
DELETE FROM klient WHERE klient_id="8";
...
INSERT INTO klient (  imie, nazwisko, rok_urodzenia, plec, data_zalozenia)
 VALUES ( 'Anna', 'Wittmann', '1985-08-13', 'K', '2021-11-21');

-- Dodać jeszce jeden wiersz w oparciu o właśnie stworzony wiersz z tym że w 
-- nowym wierszu imie ma się równać 'Jan'
INSERT INTO klient (  imie, nazwisko, rok_urodzenia, plec, data_zalozenia)
 VALUES ( 'Jan', 'Wittmann', '1985-08-13', 'K', '2021-11-21');

INSERT INTO klient (imie, nazwisko)
 select 'Jan', nazwisko from klient where imie="Anna";

-- Proszę zmodyfikować date urodzenia w nowo dodanym wierszy  dodajac miesiąc do 
-- tej co jest 
-- (dodanie +  INTERVAL 1 MONTH

update klient set 
rok_urodzenia='1985-09-13' where imie="Jan" and nazwisko="Wittmann";

update klient set 
rok_urodzenia=(rok_urodzenia+interval 1 month) where imie="Jan" and nazwisko="Wittmann";

-- Proszę skasować wiersz który utworzyliście dla siebie w tabeli klient
delete from klient where nazwisko="Wittmann";
